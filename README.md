...
-	[measurements](https://cran.r-project.org/web/packages/measurements/) converts between metric and imperial units, or calculate a dimension's unknown value from other dimensions' measurements.
...
-   [RStudio](http://www.rstudio.com/) is an integrated development environment that simplfies developing R code with numerous built-in conveniences, including vim keyboard shortcuts. There are also add-ins that make scholarly writing in RStudio easy: [wordcountaddin)](https://github.com/benmarwick/wordcountaddin), [citr](https://github.com/crsh/citr) 
