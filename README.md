...
-  For working with untidy and/or complex Excel spreadsheets (i.e. many tables in one sheet, coloured cells, cells with formulas, etc.), use [jailbreakr](https://github.com/rsheets/jailbreakr), [xlsxtractr](https://github.com/hrbrmstr/xlsxtractr), and [tidyxl](https://github.com/nacnudus/tidyxl)
-  Text data (as in sentences and paragraphs) can be read in and analysed with the [tm](http://cran.rstudio.com/web/packages/tm/index.html) package. If the text is in a PDF file, use [pdftools]( https://CRAN.R-project.org/package=pdftools).
