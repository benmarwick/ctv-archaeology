...
-	[gdata](http://cran.rstudio.com/web/packages/gdata/index.html), [openxlsx](http://cran.rstudio.com/web/packages/openxlsx/index.html), [XLConnect](http://cran.rstudio.com/web/packages/XLConnect/index.html), [xlsx](http://cran.rstudio.com/web/packages/xlsx/index.html) - These packages help you read and write Microsoft Excel files using R. The preferred method is to export your spreadsheets from Excel as CSVs and read them into R using `read.csv()`
