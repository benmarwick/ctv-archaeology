...
-   [Emacs](http://www.gnu.org/software/emacs/) is a highly flexible text editor (easiest to use with [spacemacs](http://spacemacs.org/), which when used with the [Emacs Speaks Statistics](http://ess.r-project.org/) package, is a comprehensive writing and R development environment. [Org-mode](http://orgmode.org/) provides a literate programming environment in Emacs similar to knitr. 
